####################################################################################################
#
#  Test leaf photosynthesis response 
#
#  Purpose:
#     1) Test response to light
#     2) Test response to temperature
#     3) Test leaf photosynthesis response to PSII (maximum intrinsic quantum yield) and Phi 
#         (curvature factor)
#
#
####################################################################################################
...
plot(Tl,An,type="l", lwd=3, ylab="Net Photosynthesis (umols/m2/s)", xlab="",cex.axis=cexaxis,
     cex.lab=cexlab)
box(lwd=2.2)
...
plot(Tl,Gamma_star, type="l", lwd=3, ylab="Gamma_star", xlab="",cex.axis=cexaxis,
     cex.lab=cexlab)
box(lwd=2.2)
plot(Tl,Kc, type="l", lwd=3, ylab="Kc", xlab="",cex.axis=cexaxis,
     cex.lab=cexlab)
box(lwd=2.2)
plot(Tl,Ko, type="l", lwd=3, ylab="Ko", xlab="",cex.axis=cexaxis,
     cex.lab=cexlab)
box(lwd=2.2)
#--------------------------------------------------------------------------------------------------#
## EOF