...
Func_Light_Partitioning <- function(SZA, P, PAR){
  ...
  ## Build output list
  output <- list(SZA=SZA,PAR=PAR,SV=SV*4.57,SN=SN*4.57,Ratio=Ratio,fV=fV,fN=fN,Model_DV=SV*fV*4.57,
                 Model_dV=SV*4.57-SV*fV*4.57,Model_DN=SN*fN*4.57,ModeldN=SN*4.57-SN*fN*4.57)
  return(output)
